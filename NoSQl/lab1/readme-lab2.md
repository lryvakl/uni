...
Томку я додала використання **MongoDB** для телеметрії. Замість того, щоб створювати тисячі рядків, створю колекцію `race_telemetry`.
Також використовую вкладення, тобто один документ містить дані про виступ одного пілота в одній сесії.
...
Тобто для цієї ситуації NoSQL очевидно буде набагато продуктивнішим вибором.
